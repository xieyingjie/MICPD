...
def detect_change_points(path, groundEvent, nodeImportance, alpha_pg, flag1, flag2,
    ...
    temp_f = 0.0
    pp = np.array(prScore)
    ss = np.reshape(np.array(prScore), (numSnapshots, numNodes))
    ...
    for alpha in range(1, 101, 1):
        ...
        adjacentM = distance.squareform(distance_array)
