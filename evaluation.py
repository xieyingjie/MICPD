...
def syntheticEvaluation(p_world):
    GroundEvent = set([16, 21, 34, 46, 61, 87, 95])
    s = 0
    numSnapshots = 100
    best_k = 2
    alpha = 1
    precision, recall, fvalue, fpr = Evaluation(p_world, GroundEvent, s,
                                                numSnapshots)
    print(precision)
    print(recall)
    print(fvalue)
...
if __name__ == '__main__':
    print("this is MICPD")
    p_synthetic = set([16, 21, 34, 46, 61, 87, 2, 1])
    syntheticEvaluation(p_synthetic)